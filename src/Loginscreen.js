...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register as Patron"} primary={true} style={style} onClick={(event) => this.handleClick(event,'patron')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as NGO"} primary={true} style={style} onClick={(event) => this.handleClick(event,'ngo')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      patronbuttonLabel:'Register as Patron',
      ngobuttonLabel:'Register as NGO',
      isLogin:true
    }
  }
  componentWillMount(){
